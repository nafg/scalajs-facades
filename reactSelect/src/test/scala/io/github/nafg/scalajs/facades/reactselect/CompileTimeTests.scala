...
object CompileTimeTests {
  Creatable(List(Opt("hello"), Opt("goodbye")))("hello": Id[String])()(
    _.isValidNewOption := ((_: String, _: Option[String], _: Seq[Opt[String]]) => true)
  )

  Creatable(List(Opt("hello"), Opt("goodbye")))(Option.empty[String])()(
      _.isValidNewOption := ((_: String, _: Option[String], _: Seq[Opt[String]]) => true)
  )

  Creatable(List(Opt("hello"), Opt("goodbye")))(Seq("hello"))()(
